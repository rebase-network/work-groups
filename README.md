...
CodingDay 是源自 Rebase 社区最古老的活动形式，通过线下的开发者聚会来交流前沿开发技术，帮助开发者们快速入门和上手AIGC、区块链、开源等相关技术开发。
...
极客的日常读物。每天发布一篇科技相关的技术文章，每篇文章包括三个推荐。内容题材为AIGC、前沿技术等方向。

往期内容：[https://rebase.network/geekdaily](https://rebase.network/geekdaily) 
...
Rebase D. Ventures 是发源于 Rebase 社区的社区风险投资基金，用来源于社区的资金来实现帮助和成就技术团队、项目的愿景。
...
Rebase Hackathon 是发源于 Rebase 社区的线下编程黑客松，以72小时现场编程的方式来庆祝开发者们的聚会。Rebase已举办过多期Hackathon。
...
Hacker House是一群有想法的人在一起共居共创的活动形式。参与者在一定时间内共居、交流、协作，脱离日常干扰，在沉浸式环境中集中围绕特定的领域和方向进行高强度思想碰撞和创意试验，最终将想法落地为产品和项目。

主要活动有：
2022年大理 Hacker House
2023年黑山｜土耳其｜新加坡Hacker House
2023年上海｜武汉｜深圳｜北京｜苏州｜成都Hacker House
2024年武汉 Bitcoin Spring Hacker House
2026年武汉AI Hacker House
...
线下活动，主要流程开营破冰、Workshop、自由开发、工坊研讨、Demo、合影闭营。

#### 3. 如何参与

关注Rebase，活动开启招募后即可联系。
